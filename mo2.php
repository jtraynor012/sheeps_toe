        ...
        <div class="row">
            ...
            try {
                ...
                foreach ($currentOrders as $order) {
                    ...
                    echo '<button type="button" class="btn btn-danger" onclick="voidOrder(' . $order['OrderID'] . ')">Void</button>';
                    echo '<button type="button" class="btn btn-success" onclick="completeOrder(' . $order['OrderID'] . ')">Complete</button>';
                    echo '</form>';
